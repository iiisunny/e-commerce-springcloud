...
public class SwaggerConfig {
    ...
    public Docket docket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 选择展示哪些接口
                .select()
                // 只有 com.iiisunny.ecommerce 包内的才去展示
                .apis(RequestHandlerSelectors.basePackage("com.iiisunny.ecommerce"))
    ...
    public ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                .title("iiisunny-micro-service")
                .description("e-commerce-springcloud-service")
                .contact(new Contact(
                        "iiisunny", "www.xxx.com", "xx@xx.com"
                ))
                .version("1.0")
                .build();
    }
