...
public class SentinelGatewayConfiguration {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SentinelGatewayConfiguration.class);
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api = new ApiDefinition("nacos-client-api")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    // 模糊匹配 /iiisunny/ecommerce-nacos-client/ 及其子路径的所有请求
                    add(new ApiPathPredicateItem()
                            .setPattern("/iiisunny/ecommerce-nacos-client/**")
                            // 根据前缀匹配
        ...
        ApiDefinition api1 = new ApiDefinition("nacos-client-api-1")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem()
                            // 精确匹配 /iiisunny/ecommerce-nacos-client/nacos-client/service-instance
                            .setPattern("/iiisunny/ecommerce-nacos-client" +
        ...
        ApiDefinition api2 = new ApiDefinition("nacos-client-api-2")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem()
                            // 精确匹配 /iiisunny/ecommerce-nacos-client/nacos-client/project-config
                            .setPattern("/iiisunny/ecommerce-nacos-client" +
